...
const Footer = () => {
  ...
  return (
    <footer className="bg-gradient-to-r from-blue-800 via-blue-600 to-[#EBA1FF] text-white py-8">
      <div className="container mx-auto px-4">
        <div className="flex flex-wrap justify-between">
          ...
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            ...
            <ul className="text-gray-400">
              ...
              <li><a href="#" className="hover:text-white transition-colors duration-300">Products</a></li>
        ...
        <div className="mt-8 border-t border-gray-700 pt-8 text-center text-gray-400">
          <p>&copy; {currentYear} Localpulse. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
